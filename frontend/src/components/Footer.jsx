            ...
            <div className="container">
                <div className="footer-content">
                    ...
                    <div className="footer-section contact-section">
                        <h4 className="section-title">Kontak Kami</h4>
                        <div className="contact-info">
                            ...
                            <div className="contact-item">
                                <span className="contact-icon">📧</span>
                                <span className="contact-text">info@rentalmotor.com</span>
                            </div>
                            <div className="contact-item">
                                <span className="contact-icon">📍</span>
                                <span className="contact-text">Bekasi, Jawa Barat</span>
                            </div>
                        </div>
                    </div>
                    
                    <div className="footer-section hours-section">
                        <h4 className="section-title">Jam Operasional</h4>
                    ...
                    <div className="footer-section links-section">
                        <h4 className="section-title">Tautan Cepat</h4>
                        <div className="footer-links">
                            <a href="#beranda" className="footer-link">Beranda</a>
                            <a href="#motor" className="footer-link">Daftar Motor</a>
                            <a href="#testimoni" className="footer-link">Testimoni</a>
                            <Link to="/tentang" className="footer-link">Tentang Kami</Link>
